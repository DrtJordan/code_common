...
package org.code.es.comsumer.service;
...
import org.code.es.comsumer.vo.BrandCaseInfo;
import org.code.es.comsumer.vo.NewsInfo;
import org.code.es.comsumer.vo.Person;
import org.code.es.comsumer.vo.TaskInfo;
import org.code.es.comsumer.vo.UserInfo;
...
public class ElasticsearchService {
    ...
    public void init() {
    	...
    	if (!elasticsearchTemplate.indexExists(Constants.ESProp.INDEX_NAME)) {
			elasticsearchTemplate.createIndex(Constants.ESProp.INDEX_NAME);
		}
    ...
    public boolean insertOrUpdatePerson(List<Person> list) {
    	List<IndexQuery> queries = new ArrayList<IndexQuery>();
